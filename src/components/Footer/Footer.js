    ...
    return (
      ...
      <footer className="inline-grid-row">
        ...
        <ul className="inline-grid-col">
            <li className="inline-grid-col"><a className="inline-grid-col"href="https://www.instagram.com/getPracker/" target="_blank" rel="noopener noreferrer"><img src={instagram} alt="Instagram"></img></a></li>
